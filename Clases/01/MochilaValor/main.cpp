 ...
 * Author: Ivan
 *
 * Created on 21 de marzo de 2024, 10:54
 */

/* Esta variación del ejercicio toma en consideración un valor para cada objeto
 * Adicionalmente se cambió ligeramente el algoritmo anterior */
